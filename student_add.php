...
$birth_month = mysqli_real_escape_string($connection,
$birth_month);
...
if($result) {
$message = "Mahasiswa dengan nama = \"<b>$name</b>\" sudah
berhasil di tambah";
...
?>" placeholder="Contoh: 12345678"> (8 digit angka)
</p>
<p>
...
<option value="FTEIC" <?php echo $select_fteic
?>>FTEIC</option>
</select>
</p>
<p>
...
?>" placeholder="Contoh: 2.75"> (angka desimal dipisah dengan karakter
titik ".")
</p>
</fieldset>
<br>
